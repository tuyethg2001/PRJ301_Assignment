<%-- 
    Document   : Contact
    Created on : Nov 5, 2021, 10:23:36 PM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
        ...
        <div class="p-2 pb-5 mb-5">
            <h1 class="display-5 text-center my-4 fw-bold">Contact</h1>

            <h2 class="fs-2">Mailing Address</h2>
            <p>Library, Ha Giang City</p>            
            <hr/>

            <h2 class="fs-2">Email</h2>
            <p>libraryHelp@gmail.com</p>
            <hr/>

            <h2 class="fs-2">Phone Numbers</h2>
            <p>0123456789</p>
        </div>
