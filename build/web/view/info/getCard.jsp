<%-- 
    Document   : getCard.jsp
    Created on : Nov 5, 2021, 9:49:50 PM
    Author     : DELL
--%>
...
<html>
    ...
    <body>
        ...
        <!--content-->
        <div class="p-2">
            <h1 class="display-5 text-center my-4 fw-bold">Get a Library Card</h1>

            <div>
                <h2 class="fs-2">To receive a library card:</h2>
                <ul>
                    <li>Fill out an application in person at Library location or 
                        download the application form, opens a new window, fill it 
                        out and bring it into Library location. </li>
                    <li>be 18 or over</li>
                    <li>have a phone in your name and address</li>
                    <li>have a valid email address</li>
                </ul>
            </div>

            <div>
                <h2 class="fs-2">Lost or Stolen Library Cards</h2>
                <p>To prevent unauthorized use or access, lost or stolen library 
                    cards must be reported immediately in person or by telephone. 
                    Patrons are responsible for any use of their library cards and 
                    all items checked out on their account. Lost or stolen library 
                    cards can be replaced with photo identification at Library 
                    location. A patron is allowed free replacement cards.</p>
            </div>
