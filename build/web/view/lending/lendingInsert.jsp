...
<html>
    ...
    <body>
        ...
        <!--content-->
        <div class="p-2">
            <h1 class="display-5 text-center mt-3 mb-4">Add Lending</h1>
            ...
            <form action="insert" method="POST" autocomplete="off">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="autocomplete">
                                <input id="card" type="text" name="card" class="form-control" required=""/>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th>Issue Date:</th>
                        <td><input type="date" name="issueDate" id="issueDate" class="form-control" required/></td>
                    </tr>
                    <tr>
                        <th>Barcode:</th>
                        <td>
                            <div class="autocomplete w-100 mb-2">
                ...
                <div class="col-12 mb-2">
                    <button type="button" class="btn btn-outline-success btn-sm"
                            onclick="add(content); call();"><i class="fa fa-plus"></i></button>
                </div>
        ...
        <script>
                                    ...
                                    var cards = [
            <c:forEach items="${requestScope.cards}" var="c">
                                        '<c:out value="${c.cardNumber}_${c.name}"/>',
            </c:forEach>
                                    ];
            ...
            <c:forEach items="${requestScope.items}" var="i">
                                        '<c:out value="${i.barcode}_${i.book.title}"/>',
            </c:forEach>
                                    ];
                                    autocomplete(document.getElementById("barcode"), items);

                                    var content = ["<div class=\"autocomplete w-100 mb-2\"><input type=\"text\" name=\"barcode\" class=\"form-control\" required/></div> <input type=\"date\" name=\"dueDate\" class=\"form-control\" required/>"];
        </script> 
    </body>
</html>
