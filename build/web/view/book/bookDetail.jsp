    ...
    <body>
        ...
        <div class="p-2">
            <div class="text-center p-2 mb-4">
                <h1 class="display-2">${requestScope.book.title}</h1>
                <h2 class="display-3 fst-italic">by ${requestScope.book.author}</h2>
            </div>
            ...
            <div class="row px-5 my-4">
                ...
                <div class="col-9">
                    <p class="fs-4">Publication: ${requestScope.book.publication}</p>
                    <p class="fs-4">Category: ${requestScope.book.category.name}</p>        
                    <p class="fs-4">ISBN: ${requestScope.book.isbn}</p>
                    <p class="fs-4">Price: ${requestScope.book.price}</p>
                    <p class="fs-4">Copies: ${requestScope.book.items.size()}</p>
                </div>
            </div>
                ...
                <table border="1px" class="table table-hover">
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.book.items}" var="i">
                            <tr class="table-${i.status.value eq 'Available' ? 'success' : ''}${i.status.value eq 'Loaned' ? 'warning' : ''}${i.status.value eq 'Lost' ? 'danger' : ''}">
                                <td>${i.barcode}</td>
